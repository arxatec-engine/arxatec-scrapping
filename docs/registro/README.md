...
| 2026-08-04 | [deuda-abierta.md](2026-08-04/deuda-abierta.md) | Inventario de la deuda abierta del repo con los gates en verde. El único punto con fecha es el default `llama-3.1-8b-instant` (apagado el 2026-08-16), mitigable en caliente con `LLM_MODEL`. | ✅ **D-1 resuelto el 15/08** · 🟡 D-2 · ⏸ D-3 | 2026-08-15 · `fbf4aa0` · typecheck limpio, 32/32 tests |
