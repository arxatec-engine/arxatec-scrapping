/**
 * SUNASS vía gob.pe (ver docs/plan-reguladores.md): el regulador publica su
 * normativa (~4.5k normas — consejo directivo, presidencia, gerencia,
...
export const INSTITUCION = "sunass";
export const SIGLA = "SUNASS";
