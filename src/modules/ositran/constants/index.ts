/**
 * OSITRAN vía gob.pe (ver docs/plan-reguladores.md): el regulador publica su
 * normativa (~10.3k normas — consejo directivo, presidencia, gerencia,
...
export const INSTITUCION = "ositran";
export const SIGLA = "OSITRAN";
