/**
 * OSIPTEL vía gob.pe (ver docs/plan-reguladores.md): el regulador publica su
 * normativa (~8k normas — consejo directivo, presidencia, gerencia,
...
export const INSTITUCION = "osiptel";
export const SIGLA = "OSIPTEL";
