...
export interface Config {
  ...
  userAgent: string;
  /** Término del buscador (default "TFL"). */
  term: string;
...
/** Una resolución del Tribunal de Fiscalización Laboral publicada en gob.pe. */
export interface Doc {
  /** Id numérico de gob.pe (del href) — id del ledger. */
  gid: string;
  /** Número limpio ("008-2023-SUNAFIL-TFL"). */
  numero: string;
  sumilla: string;
...
export interface Ctx {
  ...
  log: Logger;
  idx: Index;
  /** Emisor FIJO del módulo: la entidad SUNAFIL del catálogo. */
  issuer: Classif;
  stats: Stats;
