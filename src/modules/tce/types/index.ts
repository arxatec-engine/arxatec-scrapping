...
/** Una resolución del Tribunal de Contrataciones publicada en gob.pe. */
export interface Doc {
  /** Id numérico de gob.pe (del href) — id del ledger. */
  gid: string;
  /** Número limpio ("07562-2026-TCP-S1"). */
  numero: string;
  sumilla: string;
...
export interface Ctx {
  ...
  log: Logger;
  idx: Index;
  /** Emisor FIJO del módulo: la entidad OECE (dueña del Tribunal) del catálogo. */
  issuer: Classif;
  stats: Stats;
