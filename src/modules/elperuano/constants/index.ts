...
/** Página del cuadernillo (boletín) diario para una fecha YYYYMMDD. */
export function cuadernilloUrl(yyyymmdd: string): string {
  return `${BUSQUEDAS_BASE}/cuadernillo/NL/${yyyymmdd}`;
}
