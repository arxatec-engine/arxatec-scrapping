...
export interface Config {
  ...
  userAgent: string;
  /** Término del buscador (default "TFA"). */
  term: string;
...
/** Una resolución del Tribunal de Fiscalización Ambiental publicada en gob.pe. */
export interface Doc {
  /** Id numérico de gob.pe (del href) — id del ledger. */
  gid: string;
  /** Número limpio ("001-2011-OEFA/TFA"). */
  numero: string;
  sumilla: string;
...
export interface Ctx {
  ...
  log: Logger;
  idx: Index;
  /** Emisor FIJO del módulo: la entidad OEFA del catálogo. */
  issuer: Classif;
  stats: Stats;
