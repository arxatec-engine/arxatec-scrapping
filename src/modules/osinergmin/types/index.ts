...
/** Una norma de OSINERGMIN publicada en gob.pe. */
export interface Doc {
  /** Id numérico de gob.pe (del href) — id del ledger. */
  gid: string;
  /** Número limpio (resoluciones de CD/PRES/GG, reglamentos, tarifas). */
  numero: string;
  sumilla: string;
...
export interface Ctx {
  ...
  log: Logger;
  idx: Index;
  /** Emisor FIJO del módulo: la entidad OSINERGMIN del catálogo. */
  issuer: Classif;
  stats: Stats;
